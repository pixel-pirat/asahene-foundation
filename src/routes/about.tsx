...
import directorImg from "@/assets/photos/director.jpg";
...
function AboutPage() {
  ...
  return (
    <>
        ...
        <div className="mx-auto grid max-w-5xl gap-10 px-4 py-16 sm:px-6 lg:grid-cols-3">
          <div className="lg:col-span-1 flex flex-col items-center gap-4">
            <img
              ...
              className="w-48 h-48 rounded-full object-cover border-4 border-primary/30 shadow-lg object-top"
            />
          </div>
      ...
      {/* Performance photos on about page */}
      <section className="mx-auto max-w-5xl px-4 py-10 sm:px-6">
        <div className="grid grid-cols-2 gap-3">
          <div className="aspect-video overflow-hidden rounded-xl">
            <img src={perf1} alt="Performance" className="h-full w-full object-cover" />
          </div>
          <div className="aspect-video overflow-hidden rounded-xl">
            <img src={perf2} alt="Performance" className="h-full w-full object-cover" />
          </div>
        </div>
      </section>
